...
!!! summary
    ...
    As of Friday, December 08 2017, we provide 226 software packages, in 7 categories, covering 38 fields of science.
...
**computational chemistry** | `schrodinger`^<b class="lic"></b>^ | `2017-2`<br/>`2017-3` | [Website](https://www.schrodinger.com) | Schrödinger Suites (Small-molecule Drug Discovery Suite, Material Science Suite, Biologics Suite) provide a set of molecular modelling software. 
...
**deep learning** | `cudnn` | `5.1`<br/>`6.0`<br/>`7.0.1`<br/>`7.0.4` | [Website](https://developer.nvidia.com/cudnn) | NVIDIA cuDNN is a GPU-accelerated library of primitives for deep neural networks. 
